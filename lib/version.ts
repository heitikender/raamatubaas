// Versioon X.Y.Z
//  X (suur)  — Heiti otsustab, millal suur versioon vahetub
//  Y (keskmine) — Claude tõstab olulisemate uute funktsioonide puhul
//  Z (väike) — iga pisiparandus
//
// Ajalugu:
//  1.1.2 — külastuste asemel päringute loendur, viidud koos versiooniga lehe jalusesse
